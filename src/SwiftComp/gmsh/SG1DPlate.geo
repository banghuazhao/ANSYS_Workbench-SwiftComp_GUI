...
General.TrackballQuaternion2 = 0.5;
General.TrackballQuaternion3 = 0.5;
General.TranslationX = -2.279055005568668;
General.TranslationY = 0.1302317146039238;
...
View[15].Visible=0;
 ...
 View[0].TransformXX=2;
 View[1].TransformXX=2;
 View[2].TransformXX=2;
 View[3].TransformXX=2;
 View[4].TransformXX=2;
 View[5].TransformXX=2;
 View[6].TransformXX=2;
 View[7].TransformXX=2;
 View[8].TransformXX=2;
 View[9].TransformXX=2;
View[10].TransformXX=2;
View[11].TransformXX=2;
View[12].TransformXX=2;
View[13].TransformXX=2;
View[14].TransformXX=2;
View[15].TransformXX=2;
 View[0].TransformYY=2;
 View[1].TransformYY=2;
 View[2].TransformYY=2;
 View[3].TransformYY=2;
 View[4].TransformYY=2;
 View[5].TransformYY=2;
 View[6].TransformYY=2;
 View[7].TransformYY=2;
 View[8].TransformYY=2;
 View[9].TransformYY=2;
View[10].TransformYY=2;
View[11].TransformYY=2;
View[12].TransformYY=2;
View[13].TransformYY=2;
View[14].TransformYY=2;
View[15].TransformYY=2;
 View[0].TransformZZ=2;
 View[1].TransformZZ=2;
 View[2].TransformZZ=2;
 View[3].TransformZZ=2;
 View[4].TransformZZ=2;
 View[5].TransformZZ=2;
 View[6].TransformZZ=2;
 View[7].TransformZZ=2;
 View[8].TransformZZ=2;
 View[9].TransformZZ=2;
View[10].TransformZZ=2;
View[11].TransformZZ=2;
View[12].TransformZZ=2;
View[13].TransformZZ=2;
View[14].TransformZZ=2;
View[15].TransformZZ=2;
